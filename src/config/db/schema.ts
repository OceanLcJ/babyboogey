...
export const customerEmailPreference = schemaModule.customerEmailPreference;
export const operatorEmailDelivery = schemaModule.operatorEmailDelivery;
...
export const subscriptionPlanChange = schemaModule.subscriptionPlanChange;
export const paymentAuditLog = schemaModule.paymentAuditLog;
