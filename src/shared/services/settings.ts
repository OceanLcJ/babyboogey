...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      group: 'credit',
      tab: 'general',
      tip: 'initial credits amount for first login bonus',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'first login credits for free trial',
      value: 'First login bonus: 1 free 720p video',
      group: 'credit',
      tab: 'general',
      tip: 'description for initial credits',
    },
    {
      name: 'initial_credits_ip_limit_enabled',
      title: 'Initial Credits IP Limit Enabled',
      type: 'switch',
      value: 'true',
      group: 'credit',
      tab: 'general',
      tip: 'whether limit how many users can receive first login credits from the same IP within a time window',
    },
    {
      name: 'initial_credits_ip_limit_max',
      title: 'Initial Credits IP Limit Max',
      type: 'number',
      placeholder: '1',
      value: '1',
      group: 'credit',
      tab: 'general',
      tip: 'max number of first login credits grants per IP within the window (rolling)',
    },
    {
      name: 'initial_credits_ip_limit_window_days',
      title: 'Initial Credits IP Limit Window Days',
      type: 'number',
      placeholder: '7',
      value: '7',
      group: 'credit',
      tab: 'general',
      tip: 'rolling window size in days for IP limiting',
    },
    {
      name: 'initial_credits_ip_limit_source',
      title: 'Initial Credits IP Limit Source',
      type: 'select',
      value: 'both',
      options: [
        { title: 'Signup IP', value: 'signup' },
        { title: 'Claim IP', value: 'claim' },
        { title: 'Both (strict)', value: 'both' },
      ],
      group: 'credit',
      tab: 'general',
      tip: 'which IP to use for limiting: signup IP (user.ip), claim IP (session/request), or both (strict)',
    },
    {
      name: 'initial_credits_country_mode',
      title: 'Initial Credits Country Mode',
      type: 'select',
      value: 'denylist',
      options: [
        { title: 'Off', value: 'off' },
        { title: 'Denylist', value: 'denylist' },
        { title: 'Allowlist', value: 'allowlist' },
      ],
      group: 'credit',
      tab: 'general',
      tip: 'country-based rules for first login credits',
    },
    {
      name: 'initial_credits_country_list',
      title: 'Initial Credits Country List',
      type: 'text',
      placeholder: 'KP,IR,MM,IN',
      value: 'KP,IR,MM,IN',
      group: 'credit',
      tab: 'general',
      tip: 'comma/space separated ISO-2 country codes for denylist/allowlist (e.g. KP,IR,MM,IN)',
    },
    {
