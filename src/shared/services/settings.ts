...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Welcome bonus: your first short dance video is free',
      value: 'Welcome bonus: your first short dance video is free',
      group: 'credit',
      tab: 'general',
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'KP,IR,MM',
      value: 'KP,IR,MM',
      group: 'credit',
      tab: 'general',
      tip: 'comma/space separated ISO-2 country codes for denylist/allowlist (e.g. KP,IR,MM)',
    },
    {
      name: 'free_video_watermark_enabled',
      title: 'Free Video Watermark Enabled',
      type: 'switch',
      value: 'true',
      group: 'credit',
      tab: 'general',
      tip: 'Enable dynamic watermark overlays for free users on generated videos',
    },
    {
      name: 'free_video_watermark_mode',
      title: 'Free Video Watermark Mode',
      type: 'select',
      value: 'dynamic_overlay',
      options: [{ title: 'Dynamic Overlay', value: 'dynamic_overlay' }],
      group: 'credit',
      tab: 'general',
