...
export const AppContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Sign-in status is resolved client-side by the session query, which flips
  // this via setIsCheckSign. Seed a constant (not a secret-derived value) so
  // server and client render identically and no secret is referenced here.
